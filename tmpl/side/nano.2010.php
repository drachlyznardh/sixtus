<div class="section">
	...
	<p><?=$d->link('NaNoWriMo/2010/', 'Indice')?></p>
	<p><?=$d->link('NaNoWriMo/2010/Personaggi/', 'Personaggi')?></p>
</div><div class="section">
	<h2 class="opened" id="arrownano2010I-rside" onclick="javascript:cascade('nano2010I-rside')">
		Parte I: La gioventù
	</h2><div id="longnano2010I-rside">
	...
	<h2 class="opened" id="arrownano2010II-rside" onclick="javascript:cascade('nano2010II-rside')">
		Parte II: Il Potere
	</h2><div id="longnano2010II-rside">
	...
	<h2 class="opened" id="arrownano2010III-rside" onclick="javascript:cascade('nano2010III-rside')">
		Parte III: Le streghe
	</h2><div id="longnano2010III-rside">
