...
<!--div class="section"-->
	...
	<div class="section">
		<div class="inside">
			<p>
				<a href="http://validator.w3.org/check?uri=<?=$master->thispage()?>">HTML Valido</a>
			</p>
		</div><p style="text-align: center">
			<a href="http://users.skynet.be/mgueury/mozilla/">HTML5 Valido</a>
		</p><div class="outside">
			<p style="text-align: right">
				<a href="http://jigsaw.w3.org/css-validator/validator?uri=<?$master->thisstyle()?>">CSS Valido</a>
			</p>
		</div>
	</div>
	</div><div class="next">
