...
tab#v
	...
	<span class="em">Duration</span>: One scene
	<span class="em">Prerequisite Charms</span>: Flowing Mirror of Opposition, Withering Paw Strike
	sec#
	begin#outside
	...
	For the rest of the scene, the Exalt does <span class="em">not need to make
	Virtue tests</span>.
	begin#outside
...
tab#vii
	...
	<span class="em">Keywords</span>: Combo-OK, Obvious
	<span class="em">Duration</span>: Instant
	<span class="em">Prerequisite Charms</span>: Walking in the Footsteps of Ten Thousand Things
	sec#
	begin#outside
...
start#side
	...
	titler#Prodigi
	begin#ol
		li#tid#Monkey Tail Distraction Strike#i
		li#tid#Flowing Mirrof of Opposition Technique#ii
		li#tid#Body of War Meditation#iii
		li#tid#Withering Paw Strike#iv
		li#tid#Celestial Monkey Form#v
		li#tid#Walking in the Footsteps of Ten Thousands Things#vi
		li#tid#Four Halo Golden Monkey Palm#vii
		li#tid#Four Halo Golden Monkey Realignment#viii
		li#tid#Celestial Godbody Understanding#ix
	end#ol
stop#side
