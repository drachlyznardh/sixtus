...
<div class="small">
...
</div><div class="wider" id="longELyznardh">
	...
	<p>
		...
		<div class="section">
			<?=$m->mkreverse('ELyznardh', 'eLyznardh', false)?></h2>
			<p><a onclick="javascript:showTab('ELyznardh-tab','tabsimak')">Simak</a></p>
	...
	<div class="section">
		<?=$m->mkcascade('goodguys', 'Protagonisti', false)?>
		<p>
	...
	<p>
		...
		<div class="section">
			<?=$m->mkreverse('goodguys', 'Protagonisti', false)?>
			<p><a onclick="javascript:showTab('goodguystab', 'tabsacomne')">Sacomne</a></p>
			<p><a onclick="javascript:showTab('goodguystab', 'tabcorona')">Corona</a></p>
			<p><a onclick="javascript:showTab('goodguystab', 'tabjo')">Jo</a></p>
			<p><a onclick="javascript:showTab('goodguystab', 'tabtogan')">Togan</a></p>
			<p><a onclick="javascript:showTab('goodguystab', 'tabsimak')">Antico Simak</a></p>
		</div> <!-- Section -->
	</div>
</div><div class="small">
	<div class="section">
		<?=$m->mkcascade('badguys','Antagonisti', false)?>
		<p>
	...
	<div class="widecontent" id="badguys-tab">
		...
		<div class="section">
			<?=$m->mkreverse('badguys', 'Antagonisti')?>
			<p><a onclick="javascript:showTab('badguys-tab', 'secson_enka')">Son Enkà</p>
			<p><a onclick="javascript:showTab('badguys-tab', 'secvad_enka')">Vad Enkà</p>
			<p><a onclick="javascript:showTab('badguys-tab', 'seczan_enka')">Enka Zan</p>
			<p><a onclick="javascript:showTab('badguys-tab', 'seczen_enka')">Zen Enkà</p>
			<p><a onclick="javascript:showTab('badguys-tab', 'secsimak_enka')">Simak Enkà</p>
		</div>
	</div>
</div>
<?php } ?>
