<?php
	...
	$page['title'] = 'Le altre voci';
	$page['subtitle'] = 'Meglio soli che male accompagnati';

	$related['prev']['title'] = 'Capitolo III';
	$related['prev']['request'] = 'Tru/Naluten/III/';
	$related['next']['title'] = 'Capitolo V';
	$related['next']['request'] = 'Tru/Naluten/V/';

	function mkpage ($d, $s, $context) {
?>
<p>Tru Naluten &egrave; giunto al quarto capitolo. Ora che il protagonista ha finalmente un nome, posso cominciare a rendere le cose pi&ugrave; interessanti!</p>
<h2>Nei capitoli precedenti...</h2>
<p>Finalmente conosciamo il nome! La voce che pensa in bianco, il protagonista di tutta questa storia, si chiama Simak. In quello che sembra un duello contro se stesso, Simak &egrave; riuscito a vincere uno dei sigilli posti sulla sua memoria... sembra che sia stato egli stesso a sigillare i propri ricordi, e sia Ci sia il Lyz erano a conoscenza di ci&ograve;: ora Simak comincia ad avere dubbi sulla sincerit&agrave; delle persone con cui ha a che fare.</p>
