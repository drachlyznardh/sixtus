<?php
	...
	$page['title'] = 'Sacomne';
	$page['subtitle'] = '&Egrave; il suo nome';

	$related['prev']['title'] = 'Capitolo I';
	$related['prev']['request'] = 'Tru/Naluten/I/';
...
?>
						...
						<div class="inside">
							<?php $d->speak ('simak', 'Mh, Ci, dammi una spiegazione'); ?>
							<?php $d->speak ('ci', 'Si &egrave; verificato un fallimento nel tentativo di lettura di dati riservati, ossia [<span class="em">accesso negato</span>]'); ?>
						</div>
						<p>Qualunque cosa significhi questo, non credo sia un bene:</p>
						<div class="inside">
							<?php $d->speak ('simak', 'Dunque, qualcuno ti sta impedendo di ricordarti di me, giusto?'); ?>
							<?php $d->speak ('ci', '[<span class="em">Errato</span>]'); ?>
							<?php $d->speak ('simak', 'Chi te lo sta impedendo, quindi? Sei tu a non volermelo dire?'); ?>
							<?php $d->speak ('ci', 'Accesso negato [<span class="em">utente non riconosciuto</span>]'); ?>
							<?php $d->speak ('simak', 'Senti un po&apos;, credevo prendessi ordini da me. O che almeno mi stessi ad ascoltare...'); ?>
							<?php $d->speak ('ci', 'L&apos;utente attuale [<span class="em">sconosciuto</span>] non ha autorit&agrave; sufficiente'); ?>
							<?php $d->speak ('simak', 'Allora chi ha autorit&agrave; sufficiente?'); ?>
							<?php $d->speak ('ci', 'L&apos;Amministratore del Sistema'); ?>
							<?php $d->speak ('simak', 'Chi &egrave; l&apos;amministratore del sistema?'); ?>
							<?php $d->speak ('ci', 'Accesso negato'); ?>
							<?php $d->speak ('simak', 'Qual&apos;&egrave; il mio livello di autorit&agrave;?'); ?>
							<?php $d->speak ('ci', 'Il livello di autorit&agrave; di [<span class="em">sconosciuto</span>] &egrave; Amminshhhtr... shh... zzzzzz... sh...'); ?>
							<?php $d->speak ('simak', 'Ehi, Ci, che succede... c&apos;&egrave;... forse... un... probl...'); ?>
						</div>
						<p>Oh, la mia testa, sta, diventando, pesante. Ehi, perch&eacute; il terreno si sta avvicinando cos&igrave; in fretta?</p>
						<div class="inside">
							<?php $d->speak ('simak', 'Cos&apos;&egrave; questa sensazione?'); ?>
						</div>
					</div><div class="section">
						<p>Questo...</p>
						<p>&egrave;...</p>
						...
						<div class="dream">
							<?php $d->speak ('togan', '... <span title="che significa: &laquo;Principe&raquo;">Drach</span>? ... <span title="che significa: &laquo;Mio Principe&raquo;">TanDrach</span>? ... mi sentite?'); ?>
							<p>Mhh... la mia testa...</p>
							<?php $d->speak ('togan', '... TanDrach? ... Zathot &egrave; alle porte, ci invadono! Vostro fratello ha ordinato l&apos;adunata di tutte le forze di Cheskaldhum. Tutte, compreso voi.'); ?>
						</div>
						...
						<div class="dream">
							...
							<?php $d->speak ('corona', 'Questo &egrave; un dream...'); ?>
						...
						<div class="dream">
							<?php $d->speak ('corona', 'Questo &egrave;'); ?>
							<?php $d->speak ('sacomne', 'Amore, sono qui'); ?>
							<?php $d->speak ('corona', 'un sogno...'); ?>
						</div>
					</div><div class="section">
						<div class="dream">
							<p>Eh, c&apos;&eacute; un&apos;altra voce! &Egrave; una voce nuova...</p>
							<?php $d->speak ('sacomne', 'Amore, svegliati!'); ?>
							<p>Qual&apos;&egrave; il problema, sono sveglio. Ti sento bene ...</p>
							<?php $d->speak ('sacomne', 'Non mi troverai se prima non trovi te stesso. Cerca ...'); ?>
							<p>Che significa questo, cos&apos;&eacute; che dovrei cercare?</p>
							<?php $d->speak ('sacomne', 'Trova te stesso, ricorda...'); ?>
							<p>Cosa? Chi sei tu? Perch&eacute; mi dici questo?</p>
							<?php $d->speak ('sacomne', 'Tu sai chi sono ...'); ?>
							<p>Lo so?</p>
						...
						<div class="dream">
							...
							<?php $d->speak ('sacomne', 'Devi saperlo. Hai promesso'); ?>
