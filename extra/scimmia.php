<?php
	$title=array('La scimmia celeste',
		'E il suo incredibile intelligente semplice stile');
	function mkpage($d){
		$self='Extra/Scimmia/';
?>
<div class="wider">
	<div class="widelist">
		<div class="section">
			<p id="li-intro">
				<?=$d->link($self,'Celestial Monkey Style','INTRO')?>
			</p><h2 class="reverse">
				Prodigi
			</h2><p id="li-i">
				<?=$d->link($self, 'Monkey Tail Distraction Strike', 'I')?>
			</p><p id="li-ii">
				<?=$d->link($self,
					'Flowing Mirrof of Opposition Technique', 'II')?>
			</p><p id="li-iii">
				<?=$d->link($self, 'Body of War Meditation', 'III')?>
			</p><p id="li-iv">
				<?=$d->link($self, 'Withering Paw Strike', 'IV')?>
			</p><p id="li-v">
				<?=$d->link($self, 'Celestial Monkey Form', 'V')?>
			</p><p id="li-vi">
				<?=$d->link($self,
					'Walking in the Footsteps of Ten Thousands Things', 'VI')?>
			</p><p id="li-vii">
				<?=$d->link($self, 'Four Halo Golden Monkey Palm', 'VII')?>
			</p><p id="li-viii">
				<?=$d->link($self, 'Four Halo Golden Monkey Realignment', 'VIII')?>
			</p><p id="li-ix">
				<?=$d->link($self, 'Celestial Godbody Understanding', 'IX')?>
			</p>
		</div>
