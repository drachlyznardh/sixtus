<?php
	...
	$page['title'] = 'Due storie';
	$page['subtitle'] = 'Entrambe tristi';

	$related['prev']['title'] = 'Storia IX';
	$related['prev']['request'] = 'Storie/IX/';
	$related['next']['title'] = 'Storia XI';
	$related['next']['request'] = 'Storie/XI/';
...
?>
	...
	<h2>La tastiera muta, grazie ai MotorHead &ndash; 17 novembre 2010</h2>
	<p>
