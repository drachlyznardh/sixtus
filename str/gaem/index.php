...
<div class="wider">
	...
	<p>
		...
		Comincia <?=$d->link($self,'qui','START')?>.
	</p>
			</div>
		</div><div class="tab" id="tab-start">
			<div class="section">
	<p>
	...
	<h2>
		...
		È arrivato il momento di scegliere. Scegli.
			...
			<?=$d->link($self,'Oh no! Il pentolone?!?','S1')?>
	</li></ul>
			</div>
				</div><div class="tab" id="tab-s1">
			<div class="section">
	<div class="outside"><p>
	...
	<p>
		...
		alla sua porta.
			...
			«<span class="dacav">Sire! Sire! Terribile! Terribilissimo!</span>»
			piagnucolava il fabbro «<span class="dacav">Il pentolone s'è
			esaurito! Non era mai successo, in 30000000000000000000&pi;²³anni!</span>»
		</p><p>
			«<span class="dacav">Me lo ricordo, io c'ero</span>» aggiunse il nano,
			ch'era più vecchio delle fondamenta della Terra.
	</p></div><p>
	...
	<h2>
		Scelta
			...
			<?=$d->link($self,'Almeno il doppio','S2')?>
	</li></ul>
			</div>
		</div><div class="tab" id="tab-s2">
			<div class="section">
	<div class="outside"><p>
			«<span class="gods">Impossibile!</span>» pianse il GODS, non sapendo
			che fare «<span class="gods">Dove troveremo tutte queste
			puttane?</span>»
	</p></div><p>
